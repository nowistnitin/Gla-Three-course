...
function select_course_func() {
  ...
  if (typevalue == "Mathura Campus#101") {
    ...
    document.getElementById("coursepid").innerHTML =
      "<select id='courseid' form='formID' name='courseid' data-errormessage-value-missing='* Course is required!' class='input validate[required]' ><option selected='selected' value=''>Course Applying For*</option><option value='1500'>Computer Science</option><option value='1550'>CSE (AI&ML)</option></select>";
